...
namespace DSI_3K2_PPAI
{
    public partial class Form1 : Form
    {
        ...
        {
            get { return txtNombreUsu.Text; }
            set { txtNombreUsu.Text = value; }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //validacion con sql
            if (txtNombreUsu.Text == "" && txtPass.Text == "")
            {
                MessageBox.Show("El campo de Usuario y Contraseña estan vacios!");
                txtNombreUsu.Focus();
                return;
            }
            if (txtNombreUsu.Text == "")
            ...
            else
            {
                    ...
                    if (users.Validar_user(txtNombreUsu.Text, txtPass.Text) == NE_Usuarios.Respuesta.validacion_correcta)
                    {
                        ...
                        MessageBox.Show("Bienvenido " + txtNombreUsu.Text + "!");
